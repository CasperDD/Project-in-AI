...
public:
      ...
      : AbstractController("EmptyController", "$Id: tripodgait18dof.cpp,v 0.1 $")
  {
    ...
    saveFile1.open("tri_savedata1.txt", ios::out);
    saveFile2.open("tri_savedata2.txt", ios::out);
    saveFile3.open("tri_savedata3.txt", ios::out);
    saveFile4.open("tri_savedata4.txt", ios::out);
